...
public class RecipesControllerTest {
    ...
    void init() {
        ...
        recipe = new Recipes("Test Recipe", FoodType.BAKERY, "Test Ingredients", "Test Instructions", "default_image_path.jpg", 2, null);
    }
    ...
    void testAddRecipeWithMissingIngredients() {
            ...
            Recipes incompleteRecipe = new Recipes(null, FoodType.BAKERY, "Test Ingredients", "Test Instructions", null, 2, null);
    ...
    void testUpdateRecipe() {
        // Arrange
        Recipes recipe = new Recipes("Original Recipe", FoodType.MEAL, "Ingredients", "Instructions", "image_path.jpg", 2, null);
        Recipes savedRecipe = repo.save(recipe);

        savedRecipe = repo.findById(savedRecipe.getId()).orElse(null);

        Recipes updatedRecipe = new Recipes("Updated Recipe", FoodType.BAKERY, "Updated Ingredients", "Updated Instructions", "updated_image_path.jpg", 2, null);
   ...
   void testUpdateRecipe_NoChangesSaved() {
    Recipes recipeToUpdate = new Recipes("Original Recipe", FoodType.MEAL, "Ingredients", "Instructions", "image_path.jpg", 2, null);
    ...
    Recipes updatedRecipe = new Recipes("", FoodType.BAKERY, "Updated Ingredients", "Updated Instructions", "updated_image_path.jpg", 2, null);
