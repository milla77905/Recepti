...
public class RecipesControllerTest {
    ...
    void init() {
        ...
        recipe = new Recipes("Test Recipe", FoodType.BAKERY, "Test Ingredients", "Test Instructions", "default_image_path.jpg", 2, 23,23,23,23);
    }
    ...
    void testAddRecipeWithMissingIngredients() {
            ...
            Recipes incompleteRecipe = new Recipes(null, FoodType.BAKERY, "Test Ingredients", "Test Instructions", null, 2, 23,23,23,23);
    ...
    void testUpdateRecipe() {
        // Arrange
        Recipes recipe = new Recipes("Original Recipe", FoodType.MEAL, "Ingredients", "Instructions", "image_path.jpg", 2, 23,23,23,23);
        Recipes savedRecipe = repo.save(recipe);

        savedRecipe = repo.findById(savedRecipe.getId()).orElse(null);

        Recipes updatedRecipe = new Recipes("Updated Recipe", FoodType.BAKERY, "Updated Ingredients", "Updated Instructions", "updated_image_path.jpg", 2, 23,23,23,23);
   ...
   void testUpdateRecipe_NoChangesSaved() {
    Recipes recipeToUpdate = new Recipes("Original Recipe", FoodType.MEAL, "Ingredients", "Instructions", "image_path.jpg", 2, 23,23,23,23);
    ...
    Recipes updatedRecipe = new Recipes("", FoodType.BAKERY, "Updated Ingredients", "Updated Instructions", "updated_image_path.jpg", 2, 23,23,23,23);
